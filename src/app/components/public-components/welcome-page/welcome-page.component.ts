...
export class WelcomePageComponent {
  ...
  readonly faqItems = [
    {
      question: 'За який час краще оформлювати замовлення?',
      answer: 'Оптимальний термін для прийому замовлення становить 3-10 днів до події. Якщо потрібні декор, доставка або додатковий сервіс, краще звертатися завчасно.'
    },
    {
      question: 'Яка мінімальна сума замовлення?',
      answer: 'Для боксового формату мінімальна сума становить 5000 грн. Замовлення з декором стартують від 7000 грн, а мінімальна вартість декору чи сервісу окремо складає 850 грн.'
    },
    {
      question: 'Які умови оплати та бронювання дати?',
      answer: 'Замовлення приймається в роботу лише після оплати. Оплата на ФОП у розмірі 100% вноситься за 7-10 днів до події, або можлива схема 50% передплата та ще 50% не пізніше ніж за 3 дні до події. Бронювання дати становить 2500 грн.'
    },
    {
      question: 'Чи можна замовити індивідуальний набір позицій?',
      answer: 'Так, для кастомного боксу можна зібрати власний набір. Мінімальна кількість для такого формату становить від 10 штук кожної обраної позиції.'
    },
    {
      question: 'Чи доступні доставка та оформлення локації?',
      answer: 'Так, ми можемо узгодити самовивіз, доставку, монтаж декору, сервірування та додатковий персонал. До точки самовивозу діє безкоштовна доставка. Фінальна вартість інших форматів доставки залежить від адреси, часу та обраних послуг.'
    }
  ];
